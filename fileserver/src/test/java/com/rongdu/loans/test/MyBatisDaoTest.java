...
//		FileInfo entity = fileInfoManager.getById("1");
//		JedisUtils.setObject("fileInfo", entity, 10);
//		entity =  (FileInfo) JedisUtils.getObject("fileInfo");
//		System.out.println(JsonMapper.toJsonString(entity));
		
//		List<String> list = new ArrayList<String>();
//		list.add("abc");
//		list.add("123");
//		JedisUtils.setList("list", list, 10);
//		list =  (List<String>) JedisUtils.getList("list");
...
//		JedisUtils.setObjectList("fileInfoList", list, 1000);
//		list = (List<FileInfo>) JedisUtils.getObjectList("fileInfoList");
...
//		criteria.add(Criterion.eq("status", 0));
//		criteria.or(Criterion.eq("status", 1));
//		int  rowNum = fileInfoManager.deleteByCriteria(entity,criteria);
//		System.out.println(JsonMapper.toJsonString(rowNum));
//	}
//	
//	@Test
...
//		criteriaList.add(criteria3);
//		
//		int  rowNum = fileInfoManager.deleteByCriteriaList(entity,criteriaList);
//		System.out.println(JsonMapper.toJsonString(rowNum));
//	}
//	
//	@Test
...
//		fileInfoManager.deleteBatch(entity,ids);
//	}
//	
//	
//	@Test

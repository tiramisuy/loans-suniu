...
<body>
    <form action="${pageContext.request.contextPath}/api/pc-pay/pc-pay-gate" method="post">
<table width="40%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><input name="OrderMoney" type="text" id="OrderMoney" /></td>
  </tr>
  <tr>

...
public class ReadyPay{
	...
	public static void main(String[] args) throws Exception {
		...
		String ProtocolNo = "2018031318444720000117300244";//签约协议号（确认绑卡返回）
		 ...
		 */
		 ...
		 DateArry.put("risk_item", JSON.json(RiskItem).toString());//放入风控参数  JSONObject.fromObject(RiskItem).toString();

...
public class PreloanAuditReportApiInvoker {

    private final Log log = LogFactory.getLog(this.getClass());
    private static final String apiUrl = "https://apitest.tongdun.cn/preloan/report/v8";
    private PoolingHttpClientConnectionManager connMgr;
    private RequestConfig requestConfig;

    public PreloanAuditReportApiInvoker() {
        // 设置连接池
...
//		params.put("ip_address", "your_login_ip");
        ...
        FraudApiVO apiResp = new PreloanAuditReportApiInvoker().invoke(params);
    ...
    public static void heartbeat() {
        final PreloanAuditReportApiInvoker invoker = new PreloanAuditReportApiInvoker();

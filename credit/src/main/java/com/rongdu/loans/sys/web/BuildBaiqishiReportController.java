 ...
 */
@Controller
public class BuildBaiqishiReportController extends BaseController {
	@Autowired
	private CreditDataPersistenceService creditDataPersistenceService;

	@RequestMapping(value = "credit/anon/buildBaiqishiReport", method = RequestMethod.POST)
	@ResponseBody
	public Object buildBaiqishiReport(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		creditDataPersistenceService.saveBaiqishiReportFile(applyId);
		return "success";
	}

...
/**
 * 白骑士-常用联系电话（近1个月)-mnoOneMonthCommonlyConnectMobilesEntity
 * @author sunda
 * @version 2017-08-14
 */
public class ReportMnoOmccm extends BaseEntity<ReportMnoOmccm> {
	...
	public ReportMnoOmccm() {
		super();
	}

	public ReportMnoOmccm(String id){
		super(id);
	}

...
/**
 * 白骑士-联系人通话活动地区-mnoContactsCommonlyConnectAreasEntity
 * @author sunda
 * @version 2017-08-14
 */
public class ReportMnoCcca extends BaseEntity<ReportMnoCcca> {
	...
	public ReportMnoCcca() {
		super();
	}

	public ReportMnoCcca(String id){
		super(id);
	}

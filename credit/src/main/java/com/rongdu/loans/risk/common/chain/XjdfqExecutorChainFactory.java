...
import com.rongdu.loans.risk.executor.R10180001Executor;
import com.rongdu.loans.risk.executor.R10180002Executor;
import com.rongdu.loans.risk.executor.R10180003Executor;

public class XjdfqExecutorChainFactory {
...
//		chains.addExecutor(new R10170009Executor());
		...
		// 魔蝎
		chains.addExecutor(new R10180001Executor());
		chains.addExecutor(new R10180002Executor());
		chains.addExecutor(new R10180003Executor());
		// 同盾

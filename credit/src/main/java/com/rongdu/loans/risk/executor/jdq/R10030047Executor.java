 ...
 * @version 2017-11-13
 */
public class R10030047Executor extends Executor {

	@Override
	public void init() {
		super.setRuleId(RuleIds.R10030047);
	}
	...
	public void doExecute(AutoApproveContext context) {
		...
		// 命中的规则
		HitRule hitRule = checkPhoneCount(vo.getMoxieTelecomReport().user_info_check.get(0).check_search_info);
		// 决策依据

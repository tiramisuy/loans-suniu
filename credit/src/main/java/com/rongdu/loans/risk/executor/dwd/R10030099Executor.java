...
/**
 * 申请人近6个月互通过号码”数量稀少“，小于10
 *
 * @author fy
 * @version 2019-05-27
 */
public class R10030099Executor extends Executor {

    @Override
    public void init() {
        super.setRuleId(RuleIds.R10030099);
    }
    ...
    private HitRule checkRule(Report report) {
        ...
        if (report.getContactList() != null) {
            ...
            if (count < 10) {
                setHitNum(1);
                remark = String.format("申请人近6个月互通过号码”数量稀少“，小于10，近6个月通话号码数量：%s", count);

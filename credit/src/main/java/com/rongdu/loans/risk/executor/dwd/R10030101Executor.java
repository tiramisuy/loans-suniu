...
/**
 * 近6个月与填写的2个紧急联系人通话时长都小于等于20分钟
 *
 * @author fy
 * @version 2019-05-27
 */
public class R10030101Executor extends Executor {

    @Override
    public void init() {
        super.setRuleId(RuleIds.R10030101);
    }
    ...
    private HitRule checkRule(Report report, List<CustContactVO> contactList) {
        ...
        if (report.getContactList() != null) {
            ...
            A:for (CustContactVO custContactVO : contactList) {
            ...
            if (flag) {
                setHitNum(1);
                remark = "近6个月与填写的2个紧急联系人通话时长都小于等于20分钟";

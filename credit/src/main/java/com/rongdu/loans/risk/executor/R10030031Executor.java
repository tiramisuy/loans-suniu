...
/**
 * 宜信致诚-阿福共享平台 规则：在阿福共享平台存在1笔贷款当前逾期M1， 数据来源于：宜信阿福共享平台
 * 
 * @author liuzhuang
 * @version 2017-11-13
 */
public class R10030031Executor extends Executor {

	@Override
	public void init() {
		super.setRuleId(RuleIds.R10030031);
	}
	 ...
	 * 逾期笔数为1，审批结果为202(批贷已放款)且还款状态为302（逾期），逾期情况为M1,
	 * 
	 * @param loanRecords
	 * @return
	 */

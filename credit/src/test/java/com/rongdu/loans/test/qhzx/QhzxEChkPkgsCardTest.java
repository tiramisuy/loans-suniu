...
public class QhzxEChkPkgsCardTest {
	
	private static String url = QhzxConfig.domain+"/do/"+QhzxConfig.net_type+"/verify/"+QhzxConfig.eChkPkgsCard_biz_code+"/"+QhzxConfig.api_ver+"/"+QhzxConfig.eChkPkgsCard_message_code;
	/**
	 * 日志对象
	 */
	protected static Logger logger = LoggerFactory.getLogger(QhzxEChkPkgsCardTest.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String bankCardNo = "6225880138988887";
		...
		param.put("authType", "A3");
//		//鉴权类型为A4或者A6时必输
//		param.put("expiresYear", mobileNo);
//		//鉴权类型为A6时必须输入，格式：YYYY
//		param.put("expiresMonth", "A3");
//		//鉴权类型为A6时必须输入，格式：MM
//		param.put("creditCardCVN", "A3");
//		//鉴权类型为A6时必须输入，信用卡背面的安全校验码
		param.put("authType", "A3");
		...
		logger.debug("{}-{}-请求报文(明文)：{}",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,busiDataString);
		...
		logger.debug("{}-{}-请求地址：{}",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,url);
		logger.debug("{}-{}-请求报文：{}",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,requestString);
		long start = System.currentTimeMillis();
		String responseString = postForJson(url, requestString);
		long end = System.currentTimeMillis();
		long timeCost = end-start;
		logger.debug("{}-{}-耗时：{}ms",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,timeCost);
		logger.debug("{}-{}-应答结果：{}",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,responseString);
		...
		logger.debug("{}-{}-应答结果(明文)：{}",QhzxConfig.partner_name,QhzxConfig.eChkPkgsCard_biz_name,busiDataResponseString);

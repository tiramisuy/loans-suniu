...
public class QhzxAddressTest {
	
	private static String url = QhzxConfig.domain+"/do/"+QhzxConfig.net_type+"/query/"+QhzxConfig.address_biz_code+"/"+QhzxConfig.api_ver+"/"+QhzxConfig.address_message_code;
	/**
	 * 日志对象
	 */
	protected static Logger logger = LoggerFactory.getLogger(QhzxAddressTest.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String address = "深圳市宝安区福永镇福海工业区B栋公司宿舍405";
...
//		param.put("qqNo", "");
		...
		logger.debug("{}-{}-请求报文(明文)：{}",QhzxConfig.partner_name,QhzxConfig.address_biz_name,busiDataString);
		...
		logger.debug("{}-{}-请求报文：{}",QhzxConfig.partner_name,QhzxConfig.address_biz_name,requestString);
		...
		logger.debug("{}-{}-应答结果(明文)：{}",QhzxConfig.partner_name,QhzxConfig.address_biz_name,busiDataResponseString);

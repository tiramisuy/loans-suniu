...
public class QhzxCreBnkCardIncTest {
	
	private static String url = QhzxConfig.domain+"/do/"+QhzxConfig.net_type+"/query/"+QhzxConfig.creBnkCardInc_biz_code+"/"+QhzxConfig.api_ver+"/"+QhzxConfig.creBnkCardInc_message_code;
	/**
	 * 日志对象
	 */
	protected static Logger logger = LoggerFactory.getLogger(QhzxCreBnkCardIncTest.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String cardNo = "6225880138988887";
		...
		logger.debug("{}-{}-请求报文(明文)：{}",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,busiDataString);
		...
		logger.debug("{}-{}-请求地址：{}",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,url);
		logger.debug("{}-{}-请求报文：{}",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,requestString);
		long start = System.currentTimeMillis();
		String responseString = postForJson(url, requestString);
		long end = System.currentTimeMillis();
		long timeCost = end-start;
		logger.debug("{}-{}-耗时：{}ms",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,timeCost);
		logger.debug("{}-{}-应答结果：{}",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,responseString);
		...
		logger.debug("{}-{}-应答结果(明文)：{}",QhzxConfig.partner_name,QhzxConfig.creBnkCardInc_biz_name,busiDataResponseString);

...
public class Credit100SpecialListCTest {
	
	/**
	 * 日志对象
	 */
	protected static Logger logger = LoggerFactory.getLogger(Credit100SpecialListCTest.class);
	//Token
	...
	public static void main(String[] args) throws Exception {
		...
		reqData.put("strategy_id", Credit100Config.speciallistc_biz_code);
...
//		reqData.put("event", event);
		...
		logger.debug("{}-{}-请求报文：{}",Credit100Config.partner_name,Credit100Config.speciallistc_biz_name,requestJson);
	    String responseJson=ms.getApiData(requestJson,Credit100Config.api_code);	
		logger.debug("{}-{}-应答结果：{}",Credit100Config.partner_name,Credit100Config.speciallistc_biz_name,responseJson);
		...
		if (StringUtils.isNotBlank(code)&&succCode.equals(code)) {
			...
			logger.debug("{}-{}-调用失败：{}，{}，{}",Credit100Config.partner_name,Credit100Config.speciallistc_biz_name,
	...
	public static void setTokenid(String tokenid) {
		Credit100SpecialListCTest.tokenid = tokenid;
	}

...
public class Credit100RuleApplyLoanTest {
	
	/**
	 * 日志对象
	 */
	protected static Logger logger = LoggerFactory.getLogger(Credit100RuleApplyLoanTest.class);
	//Token
	...
	public static void main(String[] args) throws Exception {
		...
		reqData.put("meal", Credit100Config.ruleapplyloan_biz_code);
...
//		reqData.put("device_id", deviceId);
		...
		logger.debug("{}-{}-请求报文：{}",Credit100Config.partner_name,Credit100Config.ruleapplyloan_biz_name,requestJson);
	    String responseJson=ms.getApiData(requestJson,Credit100Config.api_code);	
		logger.debug("{}-{}-应答结果：{}",Credit100Config.partner_name,Credit100Config.ruleapplyloan_biz_name,responseJson);
		...
		if (StringUtils.isNotBlank(code)&&succCode.equals(code)) {
			...
			logger.debug("{}-{}-调用失败：{}，{}，{}",Credit100Config.partner_name,Credit100Config.ruleapplyloan_biz_name,
	...
	public static void setTokenid(String tokenid) {
		Credit100RuleApplyLoanTest.tokenid = tokenid;
	}

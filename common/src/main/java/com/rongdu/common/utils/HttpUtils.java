...
public class HttpUtils {
    ...
    public static String getForJson(String url, Map<String, String> params) {
     ...
     * @return
     */
    public static String execute(HttpPost httpRequest) {
     ...
     * @return
     */
    private static String execute(HttpGet httpRequest) {
        String respString = null;
        CloseableHttpClient httpClient = createHttpClient();
        CloseableHttpResponse httpResponse = null;
        try {
     ...
     * @return
     */
    public static String postForJson(String url, Map<String, String> params, Map<String, String> headers) {
        String respString = null;
     ...
     * @return
     */
    public static String getForJson(String url, Map<String, String> params, Map<String, String> headers) {
        String respString = null;

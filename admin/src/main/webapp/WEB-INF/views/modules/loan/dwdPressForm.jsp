...
<%--         <c:if test="${succCount > 0 and overday > 14 }">
       ...
       <li onclick="xianJinCardData('${applyId}')">大王贷报告</li>
...
<script id="tpl_userinfo" type="text/x-handlebars-template">
    <%--客户信息--%>
    <jsp:include page="../cust/dwdUserInfo.jsp"></jsp:include>
</script>
...
<script id="tpl_8" type="text/x-handlebars-template">
    <%--通讯录信息--%>
    <jsp:include page="../cust/dwdConnectInfo.jsp"></jsp:include>
</script>
...
<script id="tpl_16" type="text/x-handlebars-template">
    <%--现金白卡报告--%>
    <jsp:include page="../cust/dwdData.jsp"></jsp:include>
</script>

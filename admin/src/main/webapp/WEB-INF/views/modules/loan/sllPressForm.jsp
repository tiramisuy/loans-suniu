...
<div class="layui-tab layui-tab-card">
    <ul class="layui-tab-title">
        ...
        <li <c:if test="${page == 1}">class="layui-this" </c:if> onclick="userInfo('${userId}','${applyId}', '1')">客户信息</li>
        <c:if test="${overday > 1 }">
...
<script id="tpl_userinfo" type="text/x-handlebars-template">
    <%--客户信息--%>
    <jsp:include page="../cust/sllUserInfo.jsp"></jsp:include>
</script>
...
<script id="tpl_8" type="text/x-handlebars-template">
    <%--通讯录信息--%>
    <jsp:include page="../cust/sllConnectInfo.jsp"></jsp:include>
</script>
...
<script id="tpl_16" type="text/x-handlebars-template">
    <%--现金白卡报告--%>
    <jsp:include page="../cust/sllData.jsp"></jsp:include>
</script>

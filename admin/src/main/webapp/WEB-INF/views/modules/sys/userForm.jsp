...
<%-- 		<div class="control-group">
		...
		<h5 class="header blue">其他信息</h5>
		<div class="control-group">
			<label class="control-label"><span class="required">*</span>是否允许登录:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><span class="required">*</span>用户角色:</label>
			<div class="controls">

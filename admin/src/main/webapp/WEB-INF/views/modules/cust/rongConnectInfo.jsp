...
<fieldset class="layui-elem-field">
        ...
        <table class="layui-table" lay-even="" lay-skin="row">
            ...
            <tbody>
	            {{#each data.callInCntList}}
	            <tr data-id="{{id}}">
	                <td>{{addOne @index}}</td>
	                <td>{{contact_name}}</td>
	                <td>{{phone}}</td>
	                <td>{{phone_location}}</td>
	                <td align="center">{{contact_1w}}</td>
	                <td align="center">{{contact_1m}}</td>
	                <td align="center">{{contact_3m}}</td>
	                <td>{{talk_cnt}}/{{talk_seconds}}</td>
	                <td>{{called_cnt}}/{{called_seconds}}</td>
	            </tr>
	            {{/each}}
            </tbody>
        </table>

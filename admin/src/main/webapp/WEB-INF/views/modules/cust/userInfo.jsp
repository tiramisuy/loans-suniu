...
<form id="userInfo" class="layui-form" action="">
    ...
    <fieldset class="layui-elem-field">
        <legend>身份信息</legend>
         {{#equal sign 'check'}}
	            <input type="button" class = "layui-btn layui-btn-info" style="float: right;margin-right: 2%;margin-bottom:10px;border-radius:5px;" value="修改基本信息"  onclick="toUpdateCust('{{id}}')" /> 
            {{/equal}}
        <div class="layui-field-box">
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="{{realName}}" name="cust_realName"
                               class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="{{mobile}}" name="cust_mobile" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="{{email}}" name="cust_email" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="{{idType}}" name="cust_idType" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_idNo" value="{{idNo}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_sexStr" value="{{sexStr}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_age" value="{{age}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_idRegOrg" value="{{idRegOrg}}"
                               class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="cust_idTermBegin" value="{{idTermBegin}}"
                               class="layui-input"
                               readonly="readonly">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="cust_idTermEnd" value="{{idTermEnd}}"
                               class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
            	<div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_type" value="{{type}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_degree" value="{{degree}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_regAddr" value="{{regAddr}}"
			...
			<div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_house" value="{{house}}" class="layui-input"
                               readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_houseLoan" value="{{houseLoan}}"
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_car" value="{{car}}"
                               class="layui-input" readonly="readonly">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cust_carLoan" value="{{carLoan}}"
                               class="layui-input" readonly="readonly">
                    </div>
                </div>

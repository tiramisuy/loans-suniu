	...
	<div class="layui-tab layui-tab-card">
		<ul class="layui-tab-title">
			...
			<c:if test="${sign == 'check' or sign == 'detail' }">
				<li onclick="rongContactConectInfo('${applyId}','${vo.userInfoVO.id}')">
					通讯录</li>
			</c:if>

			<c:if test="${sign == 'check'}">
				<li
					onclick="approveView('${applyId}','${vo.userInfoVO.id}','${vo.userInfoVO.realName}','${vo.userInfoVO.mobile}')">
					审批</li>
			</c:if>
			...
			<form id="checkForm" class="layui-form"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select id="approveAmt" name="approveAmt" maxlength="100" lay-verify="">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input placeholder="15" class="layui-input" id="approveTerm"
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea placeholder="100字以内" class="layui-textarea"
...
<script id="tpl_7" type="text/x-handlebars-template">
    <%--客户信息--%>
    <jsp:include page="rongUserInfo.jsp"></jsp:include>
</script>
<script id="tpl_8" type="text/x-handlebars-template">
    <%--通讯录信息--%>
    <jsp:include page="rongConnectInfo.jsp"></jsp:include>
</script>
...
<script>
    ...
    function applyCheck(form, productId) {
        ...
        if (productId == 'XJD') {
            ...
            if(form.checkResult.value == '1' && form.approveTerm.value == '15' && form.approveAmt.value>'1500'){
        		alert("15天产品审批金额不能超过1500");
            	return false;
        	}
        }
        if (productId == 'XXX') {

	...
	<script type="text/javascript">
		...
		$(function(){
			...
			function loadTableInfo(){
				var tableId = $("#genTableId").find("option:selected").val();
				$.post("${ctx}/gen/genTable/get",
					{id:tableId},
					function(result){
						$("#name").val(result.comments);
    					$("#moduleName").val(result.moduleName);
    					$("#functionName").val(result.comments);
    					$("#functionNameSimple").val(result.comments);
  				});
			}
		});
	</script>
...
<body>
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<sys:message content="${message}"/>
			...
			<div class="controls">
				<form:select path="genTable.id" id="genTableId" class="required input-xlarge">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.rongdu.loans</span>
			</div>
		</div>
		<div class="control-group">

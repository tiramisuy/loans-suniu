 ...
 */
package com.rongdu.loans.gen.util;
...
import com.rongdu.common.mapper.JaxbMapper;
import com.rongdu.common.utils.DateUtils;
import com.rongdu.common.utils.FileUtils;
import com.rongdu.common.utils.FreeMarkers;
import com.rongdu.common.utils.StringUtils;
import com.rongdu.loans.gen.entity.GenCategory;
import com.rongdu.loans.gen.entity.GenConfig;
import com.rongdu.loans.gen.entity.GenScheme;
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (!StringUtils.equalsIgnoreCase(column.getName(), "id")
					...
					&& !StringUtils.equalsIgnoreCase(column.getName(), "del")){
				column.setIsEdit("1");
			}

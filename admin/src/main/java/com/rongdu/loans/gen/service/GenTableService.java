...
import com.rongdu.loans.gen.dao.GenDataBaseDictDao;
import com.rongdu.loans.gen.dao.GenTableColumnDao;
import com.rongdu.loans.gen.dao.GenTableDao;
import com.rongdu.loans.gen.entity.GenTable;
import com.rongdu.loans.gen.entity.GenTableColumn;
import com.rongdu.loans.gen.util.GenUtils;
		...
		if (StringUtils.isNotBlank(genTable.getName())){
			...
			if (list.size() > 0){
				...
				if (StringUtils.isBlank(genTable.getId())){
					...
					//约定，数据库表名第一个下划线前代表模块名，之后是对应实体的名称，如：sys_user
					String moduleName = StringUtils.substringBefore(genTable.getName(), "_");
					String tableName = StringUtils.substringAfter(genTable.getName(), "_");

...
public class RepayReportTodayVo implements Serializable {
...
//	@ExcelField(title = "贷款审批金额", type = 1, align = 2, sort = 6)
	...
	@ExcelField(title = "借款期限(按天)", type = 1, align = 2, sort = 7)
...
//	@ExcelField(title = "中介服务手续费", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "应还日期", type = 1, align = 2, sort = 15)
...
//	@ExcelField(title = "是否已经结清", type = 1, align = 2, sort = 26)
	...
	// @ExcelField(title="还款类型", type=1, align=2, sort=230)

...
public class CheckBlackInfo implements Serializable{
    ...
    private static final long serialVersionUID = 6359213679158800129L;
    ...
    private int contactsRouterRatio;
    ...
    public void setContactsRouterRatio(int contactsRouterRatio) {
         this.contactsRouterRatio = contactsRouterRatio;
     }
     public int getContactsRouterRatio() {

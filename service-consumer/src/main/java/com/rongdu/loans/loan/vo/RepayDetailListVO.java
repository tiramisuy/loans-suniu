 ...
 */
public class RepayDetailListVO implements Serializable {
    ...
    public String getApplyCreateTime() {
		return DateUtils.formatDate(applyCreateTime, "yyyy-MM-dd HH:mm:ss");
	}
	...
	public String getWithDrawalStr() {
		return withDrawalStr;
	}

	public void setWithDrawalStr(String withDrawalStr) {
		this.withDrawalStr = withDrawalStr;
	}

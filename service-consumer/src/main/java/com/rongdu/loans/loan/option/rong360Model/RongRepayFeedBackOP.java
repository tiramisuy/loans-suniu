...
public class RongRepayFeedBackOP implements Serializable {
	...
	/*public void setRepayPlace(Integer repayPlace) {
		switch (repayPlace.intValue()) {
		case Global.REPAY_TYPE_MANUAL:
		case Global.REPAY_TYPE_MANPAY:
			this.repayPlace = "1";//1：主动还款
			break;
		case Global.REPAY_TYPE_AUTO:
			this.repayPlace = "2";//2：机构方自动发起代扣
			break;
		default:
			this.repayPlace = "3";//3：在融360主动申请展期
			break;
		}
	}*/
}

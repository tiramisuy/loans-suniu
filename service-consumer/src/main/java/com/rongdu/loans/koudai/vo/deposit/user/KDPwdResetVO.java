...
public class KDPwdResetVO implements Serializable {
	/**
	 * 
	 */
	...
	private KDPwdResetDataVO retData;// 返回数据 json
	...
	public KDPwdResetDataVO getRetData() {
		return retData;
	}

	public void setRetData(KDPwdResetDataVO retData) {

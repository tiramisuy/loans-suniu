...
public class KDOpenAccountQueryResultVO implements Serializable {
	/**
	 * 
	 */
	...
	private KDOpenAccountQueryResultDataVO retData;// 返回数据 json
	...
	public KDOpenAccountQueryResultDataVO getRetData() {
		return retData;
	}

	public void setRetData(KDOpenAccountQueryResultDataVO retData) {

...
/**
 */
@Service("pushUserBaseInfoConsumer")
public class PushUserBaseInfoConsumer implements ChannelAwareMessageListener {
    @Autowired
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        try {
            ...
            logger.debug("现金白卡推送基本信息消费者：{}，{}，{}", msg.getSource(), msg.getType(), msg.getBizId());
            XianJinBaiKaCommonOP xianJinBaiKaCommonRequest = msg.getMessage();
            boolean flag = xianJinBaiKaService.savePushUserBaseInfo(xianJinBaiKaCommonRequest);
            if (!flag) {

...
<link href="${pageContext.request.contextPath}/res/widget/cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
<script src="${pageContext.request.contextPath}/res/widget/cron/jquery.easyui.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/res/widget/cron/cron.js" type="text/javascript"></script>
        <div class="easyui-layout" style="width: 75.5%;height:500px; border: 1px rgb(202, 196, 196) solid;border-radius: 5px;">
            ...
            <div data-options="region:'south',border:false" style="height:250px">
                <fieldset style="border-radius: 3px; height: 210px;border-color: #F9FBFD;">
                    <legend>表达式</legend>
                    <table style="height: 100px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="v_second" class="col" value="*" readonly="readonly"  style="width: 100%;"/>
                                </td>
                                <td>
                                    <input type="text" name="v_min" class="col" value="*" readonly="readonly" style="width: 100%;"/>
                                </td>
                                <td>
                                    <input type="text" name="v_hour" class="col" value="*" readonly="readonly"style="width: 100%;" />
                                </td>
                                <td>
                                    <input type="text" name="v_day" class="col" value="*" readonly="readonly" style="width: 100%;"/>
                                </td>
                                <td>
                                    <input type="text" name="v_mouth" class="col" value="*" readonly="readonly" style="width: 100%;"/>
                                </td>
                                <td>
                                    <input type="text" name="v_week" class="col" value="?" readonly="readonly" style="width: 100%;"/>
                                </td>
                                <td>
                                    <input type="text" name="v_year" class="col" readonly="readonly" style="width: 100%;"/>
                                </td>
                            </tr>
                             <tr>
							    <td>Cron 表达式:</td>

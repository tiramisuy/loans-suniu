...
public class MD5 {
	...
	/**
	 * 修改PASSWORDSET和OWNPASSWORD属性来制定用何种默认密码 1.PASSWORDSET为defalut
	 * password与客户代码一致 2.PASSWORDSET不为defalut password为OWNPASSWORD的值
	 */
	static final String PASSWORDSET = "defalut";
	static final String OWNPASSWORD = "a123456";
	/*
...
//	 */
//	 public static void md5Str2Kcol(KeyedCollection kCol,String userId) throws
//	 InvalidArgumentException, ObjectNotFoundException{
//	
//	 if (MD5.PASSWORDTYPE.equals(MD5.PASSWORDSET)){
//	 kCol.setDataValue("usr_password", MD5.getMD5ofStr(userId+userId));
//	 }else{
//	 kCol.setDataValue("usr_password",
//	 MD5.getMD5ofStr(userId+MD5.OWNPASSWORD));
//	 }
//	
//	 }
//	
//	 public static void md5Str2Kcol(KeyedCollection kCol,String userId,String
//	 usrPassword) throws InvalidArgumentException, ObjectNotFoundException{
//	
//	
//	 kCol.setDataValue("usr_password", MD5.getMD5ofStr(userId+usrPassword));
//	 }
//	
...
//	 }
	...
	public static void main(String[] a) {
		...
		System.out.println(MD5.getMD5ofStr("admin000000"));
	}

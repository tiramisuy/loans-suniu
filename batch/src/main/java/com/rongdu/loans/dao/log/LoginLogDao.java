 ...
 */
@Repository
public class LoginLogDao extends HibernateDao<LoginLog, Long> {
	
	public Long countByProperty(String propertyName, Object value) {
		String hql = "from LoginLog where "+propertyName+"=?";
	...
	public int batchDelete(Long[] ids) {
		...
		hql.append("delete from LoginLog entity where entity.id in");

package com.rongdu.loans.koudai.api;
...
public class Demo {
	...
	public static void main(String[] args) throws Exception {
		...
		map.put("project_name", "koudai_jubaoqianbao_2017");
		map.put("pwd", "123456");
		map.put("yur_ref", "1020180705161034972242772251");
		map.put("user_id", "650004917");
		map.put("real_name", "龚涵映");
		map.put("bank_id", "1");
		map.put("card_no", "6222023632072496100");
		map.put("money", "400000");
		map.put("fee", "0");
		map.put("pay_summary", "测试放款");
		// 加签
		String sign = createSign(map, "**kdpay_koudai_jubaoqianbao_2017**");
		map.put("sign", sign);

...
public class LoanApply extends BaseEntity<LoanApply> {
	...
	public String toString() {
		return "LoanApply{" +
				...
				", promotionCaseId='" + promotionCaseId + '\'' +
				", purpose='" + purpose + '\'' +
				", applyAmt=" + applyAmt +
				...
				", payTime=" + payTime +
				", urgentPayed='" + urgentPayed + '\'' +
				", loanSuccCount=" + loanSuccCount +
				", countUserBindCardPv='" + countUserBindCardPv + '\'' +
				'}';
	}

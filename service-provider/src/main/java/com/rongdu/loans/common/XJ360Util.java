...
public class XJ360Util {
    ...
    public static String XianJinBaiKaRequest(Object obj, String call) throws Exception {
        XJ360Util.init(XianJinBaiKaConfig.xianjinbaika_ua, XianJinBaiKaConfig.xianjinbaika_signkey, XianJinBaiKaConfig.xianjinbaika_url);
        String json = JsonMapper.toJsonString(obj);
        String sign = XJ360Util.getRequestSign(call, json);
        String postfileds = "ua=" + UA + "&call=" + call + "&args=" + json + "&sign=" + sign;
        return XJ360Util.sendRequest(postfileds);
    }

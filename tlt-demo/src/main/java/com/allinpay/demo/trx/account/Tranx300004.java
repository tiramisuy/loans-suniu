...
public class Tranx300004 {
	...
	public static void main(String[] args){
		InfoReq infoReq = DemoUtil.makeReq("300004", DemoConfig.merchantid, DemoConfig.username, DemoConfig.userpass);
		EtQueryReq  cashReq = new EtQueryReq();
		cashReq.setACCTNO("200604000005095001");//通联账户
		cashReq.setSTARTDAY("20180905");
		cashReq.setENDDAY("20180905");

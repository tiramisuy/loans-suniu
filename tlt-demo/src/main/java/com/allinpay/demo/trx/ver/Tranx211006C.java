...
public class Tranx211006C {
	...
	public static void main(String[] args){
		InfoReq infoReq = DemoUtil.makeReq("211006C", DemoConfig.merchantid, DemoConfig.username, DemoConfig.userpass);
		
		RNPC rnpc = new RNPC();
		rnpc.setMERCHANT_ID(DemoConfig.merchantid);
		rnpc.setSRCREQSN("200604000005095-0001536137056836");

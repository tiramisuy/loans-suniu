...
public class Tranx100001 {
	...
	public static void main(String args[]){
		InfoReq inforeq = DemoUtil.makeReq("100001", DemoConfig.merchantid, DemoConfig.username, DemoConfig.userpass);
    	...
    	trans_detail.setACCOUNT_NAME("DONHU304400") ;
		...
		trans_detail2.setACCOUNT_NAME("DONHU304300") ;

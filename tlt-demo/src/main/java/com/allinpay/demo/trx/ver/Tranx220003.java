...
import com.allinpay.demo.xstruct.ver.idv.VerQry;


/**
 * @Description  国民身份验证查询
 * @Author meixf@allinpay.com
 * @Date 2018年5月29日
 **/
public class Tranx220003 {

	public static void main(String[] args){
		InfoReq infoReq = DemoUtil.makeReq("220003", DemoConfig.merchantid, DemoConfig.username, DemoConfig.userpass);
		
		VerQry vbreq=new VerQry();
		vbreq.setQSN("200604000000445-0001527735713579");
		vbreq.setQTARGET("1");
		...
		try{
			...
			if("0000".equals(infoRsp.getRET_CODE())){
				VALIDRETDTL ret = (VALIDRETDTL)rsp.trxObj();
